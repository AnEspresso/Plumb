...
t('unlinked overflow adds on top and flags', r2.exposure===11500&&r2.overflow===1500, JSON.stringify(r2));
...
t('linked overpay lifts exposure and goes amber', r4.exposure===11500&&r4.overpaid===1, JSON.stringify(r4));
...
$("document.getElementById('caPayeeSel').value='__other'");$('caPayeeChange()');
setVal('caPayee','Sim Pay Co');setVal('caAmount','2500');
$('saveCostActual()');
const paid=JSON.parse($("JSON.stringify((state.projects[0].costs||[]).filter(a=>a.rt==='actual'&&a.payee==='Sim Pay Co'))"));
t('payment saved linked to the contract with a date', paid.length===1&&paid[0].toward==='la1'&&paid[0].t>0, JSON.stringify(paid));
