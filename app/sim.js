...
t('new walkthrough is five spots', SRC.indexOf("Glad you")>=0&&SRC.indexOf('teamLegacy:[')>=0&&SRC.indexOf('little briefcase')>=0);
t('walkthrough has spoken scripts', SRC.indexOf("say:'Hey. Glad")>=0&&SRC.indexOf('function tourWarmVoice')>=0&&SRC.indexOf('function tourChunks')>=0);
